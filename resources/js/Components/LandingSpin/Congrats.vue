		...
		<div id="congrats-content">
			...
			<div class="bg-wrap">
				...
				<div class="cont">
					...
					<div class="scoll-num amount sxm7p3g"><span v-if="prize.currency == 'RUB'">Rub$&nbsp;</span>{{ (animatedNumber).toFixed(2).replace('.',',') }} <span v-if="prize.currency != 'RUB'">{{ prize.currency }}</span></div>
