<template>
    <BaseLayout>
        <div
            class="container mx-auto p-4 mt-20 relative min-h-[calc(100vh-565px)]"
        >
            <div
                v-if="wallet && !isLoading"
                class="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-4"
            >
                <div
                    v-if="isShowForm"
                ...
                >
                    ...
                    <div class="mt-3 p-4">
                        ...
                        <div class="mt-5 flex justify-end items-end">
                            <button
                                @click="
                                    $router.push('/terms-conditions/reference')
                                "
                                type="button"
                                class="text-gray-500 hover:text-gray-600 dark:text-gray-300 hover:dark:text-gray-400"
                            >
                                {{ $t("Terms and Conditions of Reference") }}
                ...
                <div class="col-span-2 w-full">
                    ...
                    <div
                        class="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-4 mt-3"
                    >
                        <div
                        ...
                        >
                            <div class="header flex justify-between">
                                ...
                                >
                                    {{ $t("Details") }}
                                    <i
                                        class="fa-solid fa-chevron-right ml-2"
                                    ></i>
                                </button>
                            </div>
                    ...
                    <div
                        class="flex shadow dark:bg-gray-800 dark:border-gray-700 w-full rounded-lg"
                    >
                        <div class="p-4">
                            <img
                        ...
                        <div class="flex flex-col justify-center p-4">
                            ...
                            <p class="text-gray-500">
                                Наша платформа имеет передовую партнерскую
                                панель, позволяющую просмотреть gодробности о
                                прибылях и потерях.
                            </p>
                        </div>
                    </div>
            ...
            <div class="relative max-h-full w-full max-w-2xl">
                ...
                >
                    ...
                    <div class="flex flex-col w-full justify-center p-4">
                        ...
                        >
                            <div class="l"></div>
                            <div class="text-white px-3">Комитет ставки</div>
                            <div class="r"></div>
                        </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-400 text-sm">
                                            <strong class="text-gray-400"
                                                >Игра:</strong
                                            >
                                            Слоты третьих лиц, живое казино
                                        </p>
                                    </div>
                                </li>
                                <li
                        ...
                        <div class="mt-5 ml-4">
                            <ul class="list-outside list-disc">
                                <li class="mb-3">
                                    В любом общественном месте (например,
                                    университеты, школы, библиотеки и офисные
                                    пространства) может быть выплачена только
                                    одна комиссия на каждого пользователя,
                                    IP-адрес, электронное устройство, место
                                    жительства, номер телефона, метод оплаты,
                                    адрес электронной почты и компьютер, а также
                                    IP-адрес, который используется совместно с
                                    другими людьми.
                                </li>
                                <li class="mb-3">
                                    Наше решение о принятии ставки будет
                                    полностью основываться на нашем усмотрении
                                    после внесения депозита и успешной ставки.
                                </li>
                                <li class="mb-3">
                                    Комиссии могут быть сняты в нашем внутреннем
                                    кошельке CREDK на панели управления в любое
                                    время. (Посмотрите процесс снятия комиссии в
                                    панели и проверьте баланс в кошельке).
                                </li>
                                <li class="mb-3">
                                    Мы поддерживаем большинство валют на рынке.
                                </li>
                                <li class="mb-3">
                                    Система рассчитывает комиссию каждые 24
                                    часа.
                                </li>
                            </ul>
                        </div>
                        ...
                        >
                            Если у вас есть какие-либо вопросы по нашим
                            правилам, пожалуйста,
                ...
                >
                    ...
                    <div class="flex flex-col w-full justify-center p-4">
                        <form action="" @submit.prevent="makeWithdrawal">
                            ...
                            <div class="dark:text-gray-400 mb-3">
                                <label for="">Введите ключ</label>
                                <input
                                    v-model="withdrawalForm.pix_key"
                                    type="text"
                                    class="input"
                                    placeholder="Введите свой PIX"
                                    required
                                />
                            </div>

                            <div class="dark:text-gray-400 mb-3">
                                <label for="">Тип ключа</label>
                                <select
