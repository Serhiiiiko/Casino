        ...
        <div class="md:w-4/6 2xl:w-4/6 mx-auto p-4 mt-20">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="col-span-2 relative">
                    ...
                    >
                        <!-- Форма для вывода в USD (банковский перевод) -->
                        <form
                        ...
                        >
                            <div class="flex items-center justify-between">
                                <div>
                                    <i
                                        class="fa-regular fa-building-columns text-lg mr-3"
                                    ></i>
                            ...
                            <div class="mt-5">
                                <div class="dark:text-gray-400 mb-3 text-sm">
                                    <label for=""> Имя владельца счёта </label>
                                    <input
                                        v-model="withdraw_deposit.name"
                                        type="text"
                                        class="input"
                                        placeholder="Введите имя владельца счёта"
                                        required
                                    />
                                </div>
                        ...
                        >
                            ...
                            <div class="mt-5">
                                ...
                                <div class="dark:text-gray-400 mb-3">
                                    <label for=""> Ключ Pix </label>
                                    <input
                                        v-model="withdraw.pix_key"
                                        type="text"
                                        class="input"
                                        placeholder="Введите свой Pix-ключ"
                                        required
                                    />
                                </div>
...
export default {
    ...
    computed: {},
    mounted() {
        // Здесь можно выполнять действия после монтирования
    },
    methods: {
        setMinAmount() {
...
<style scoped>
/* Здесь можно разместить стили (при необходимости) */
</style>
